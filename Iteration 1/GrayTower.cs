...
{
    internal class GrayTower : Towers
    {
        public GrayTower(GameLogic gameLogicInstance, GameBoard gameboard, Point position, TableLayoutPanel Control) : base(gameLogicInstance, gameboard, position, Control)
        {
            Damage = 15;
            FireRate = 5;
            Range = 200;
            attackTimer.Interval = 1000 / (int)FireRate;
            sprite = Properties.Resources.Gray_Tower;
            color = Color.Gray;
            DamageType = Enemy.enemyType.Gray;
